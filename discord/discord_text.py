...
#// //#
    ...
    async def help(self, ctx):
        ...
        .add_field(name="Debug Commands", value=".ping - Shows the bot's ping \n.echo - [text] - Echoes the text back.\n.rename [name] - Renames the Bot", inline=False)\
        .add_field(name="Version Commands", value=".changelog - Shows the recent changelog of the bot.\n.support - Shows the supported services\n.issue - File a bug report.")\
...
#// //#
    ...
    async def issue(self, ctx):
        embed = discord.Embed(title="Found a bug?", color=0x00ffcc, url="https://github.com/tooxo/Geiler-Musik-Bot/issues")\
        .add_field(name="What should I do?", value="Create a new Issue or responde to an existing one, describing your issue.")\
        .add_field(name="Link?", value="https://github.com/tooxo/Geiler-Musik-Bot/issues\nhttps://github.com/tooxo/Geiler-Musik-Bot/issues/new")
        await ctx.send(embed=embed)
